...
### 🧠 医療AI・LLM開発
東京大学 松尾・岩澤研究室の日本語版医療特化型LLM開発に、医師・エンジニアとして参画。医療現場の実務知とソフトウェア開発の両面から、医療LLMの開発・評価・社会実装に向けた検証に関わった。

#### 日本語版医療特化型LLM開発
戦略的イノベーション創造プログラム（SIP）第3期「統合型ヘルスケアシステムの構築における生成AIの活用」（[SIP第3期 採択情報](https://sip3.jihs.go.jp/news/2024/publicrecruitmentresult.html)、[松尾・岩澤研究室 2026年3月発表](https://weblab.t.u-tokyo.ac.jp/news/2026-03-05-02/)）において、医療知識を備えたLLMの開発、電子カルテデータ標準化、ユースケース検証に関わった。
...
### 🧠 Medical AI & LLM Development
Participated as a physician-engineer in the development of Japanese medical-specialized LLMs at the University of Tokyo Matsuo-Iwasawa Laboratory. Contributed to development, evaluation, and social implementation validation by combining clinical expertise with software engineering.

#### Japanese Medical-Specialized LLM Development
Contributed to LLM development, electronic health record data standardization, and use-case validation through the Cross-ministerial Strategic Innovation Promotion Program (SIP) Phase 3, "Application of Generative AI in the Development of an Integrated Healthcare System" ([SIP Phase 3 selection information](https://sip3.jihs.go.jp/news/2024/publicrecruitmentresult.html), [Matsuo-Iwasawa Laboratory March 2026 announcement](https://weblab.t.u-tokyo.ac.jp/news/2026-03-05-02/)).
